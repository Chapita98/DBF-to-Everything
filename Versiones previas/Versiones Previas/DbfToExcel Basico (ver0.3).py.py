...
def actualizar_lista_archivos():
    ...
    if os.path.isdir(directorio):
        ...
        print(f"Archivos .dbf encontrados: {len(archivos_dbf)}")  # Mensaje de depuración
...
lista_archivos = tk.Listbox(frame_lista, selectmode=tk.MULTIPLE, yscrollcommand=scrollbar.set, width=60, height=15)
