...
def abrir_ventana_constraints(ruta_dbf):
    ...
    for field in campos:
        ...
        variables[nombre] = {
            ...
            "Tamaño": tk.StringVar(value=config.get(nombre, {}).get("Tamaño", "Original")),
            "Tamaño_Personalizado": tk.StringVar(value=config.get(nombre, {}).get("Tamaño_Personalizado", str(field.length)))
        }
        ...
        tk.Label(frm_campo, text="Tamaño:").pack(side="left")
        for tam in ["20", "50", "150", "Personalizado"]:
            tk.Radiobutton(frm_campo, text=tam, variable=variables[nombre]["Tamaño"], value=tam).pack(side="left")
        tk.Entry(frm_campo, textvariable=variables[nombre]["Tamaño_Personalizado"], width=5).pack(side="left")
    ...
    def guardar():
        ...
        for nombre, vars in variables.items():
            config[nombre] = {
                ...
                "Tamaño": vars["Tamaño"].get(),
                "Tamaño_Personalizado": vars["Tamaño_Personalizado"].get()
            }
